# Generated by Django 5.0 on 2026-02-27 06:58
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "coverage_mode",
                    models.CharField(
                        choices=[("SMOKE_NEGATIVE", "Smoke + Negative")],
                        default="SMOKE_NEGATIVE",
                        max_length=32,
                    ),
                ),
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="test_generation.generationjob",
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "artifact_type",
                    models.CharField(
                        choices=[("PAGE_OBJECT", "Page Object"), ("SPEC", "Spec")],
                        max_length=32,
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "scenario_type",
                    models.CharField(
                        choices=[("SMOKE", "Smoke"), ("NEGATIVE", "Negative")],
                        default="SMOKE",
                        max_length=32,
                    ),
                ),
