...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("test_analytics", "0006_testcaseresult_cache_metrics"),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("job", models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name="execution_links", to="test_analytics.generationjob")),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("job", models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name="artifacts", to="test_analytics.generationjob")),
            ],
            options={
                "ordering": ["-created_on"],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("job", models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name="scenarios", to="test_analytics.generationjob")),
            ],
            options={
                "ordering": ["-created_on"],
